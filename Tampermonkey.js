// ==UserScript==
// @name         小米商城手机抢购
// @namespace    https://github.com/alterhu2020
// @version      0.1
...
(function () {
    ...
    class FlashSale {
        inialize() {//初始化
            ...
            if (pathname.startsWith('/buy/detail')) {
                //商品详情页面,例如小米11 Pro页面: https://www.mi.com/buy/detail?product_id=13650
                sleep(2000).then(() => {
